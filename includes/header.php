                        ...
                        <div class="nav-row-inner">
                            ...
                            <nav class="nav-menu nav-menu-top">
                                <ul class="nav-list nav-list-top">
                                    ...
                                    <li class="nav-item-top <?= ($current_page == 'opportunities.php') ? 'active' : '' ?>">
                                        <a href="opportunities.php"
                                            class="nav-link-top <?= ($current_page == 'opportunities.php') ? 'active' : '' ?>">
                                            Opportunities
                                        </a>
                                    </li>

                                    <li class="nav-item-top <?= ($current_page == 'contact.php') ? 'active' : '' ?>">
                                        <a href="contact.php"
                                            class="nav-link-top <?= ($current_page == 'contact.php') ? 'active' : '' ?>">
                                            Contact Us
                                        </a>
                                    </li>
