...
if ($id && !$row) { Session::flash('error', 'SEO record not found.'); redirect(adminUrl('seo/')); }
...
<div class="form-grid">
  ...
  <label>Open Graph Image<input name="og_image" value="<?= e((string)($row['og_image'] ?? '')) ?>" maxlength="500"></label>
