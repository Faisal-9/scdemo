...
?><main class="admin-main management-page"><div class="admin-container"><div class="media-library-hero management-hero"><div><span class="management-kicker">Content workspace</span><h1>Media Library</h1><p>One central place for images and documents used by the CMS.</p></div><div class="media-library-actions"><a class="btn btn-primary" href="<?=e(adminUrl('assets-library/upload.php'))?>">Upload</a><a class="btn btn-secondary" href="<?=e(adminUrl('assets-library/picker.php'))?>">Open Picker</a></div></div>
