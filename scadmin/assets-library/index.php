...
$rows=MediaLibraryManager::list(['search'=>trim((string)($_GET['q']??'')),'type'=>(string)($_GET['type']??''),'scope'=>(string)($_GET['scope']??'')]);
