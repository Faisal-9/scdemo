...
try {
    ...
    NavigationManager::toggle((int)$id);
    Auth::audit(Auth::id(), 'update', 'navigation', (int)$id, 'Updated navigation visibility.');
    Session::flash('success', 'Navigation visibility updated.');
