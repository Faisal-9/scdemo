...
<main class="admin-content">
    <?php $breadcrumbs = [['label' => 'Dashboard', 'url' => adminUrl('dashboard.php')], ['label' => 'Homepage', 'url' => null]];
    require __DIR__ . '/../partials/breadcrumbs.php';
    $heading = 'Homepage';
    $description = 'Manage the existing homepage data without changing the current public HTML/CSS/JS.';
    $actionUrl = null;
    $actionLabel = null;
    ...
    <section class="content-panel" id="homepage-hero">
        <div class="panel-heading">
            <div>
                <h2>Hero slides</h2>
                <p class="muted">Existing five-slide structure. Keep legacy IDs stable.</p>
            </div><a class="button-link" href="<?= e(adminUrl('homepage/slide.php')) ?>">+ Add slide</a>
        </div>
        <div class="table-wrap">
            <table class="admin-table">
                ...
                <tbody>
                    <?php foreach ($slides as $row): ?><tr>
                            <td><?= e((string)$row['sort_order']) ?></td>
                            <td><code><?= e((string)$row['legacy_id']) ?></code></td>
                            <td><strong><?= e($row['title']) ?></strong></td>
                            <td><?= e($row['image_path'] ?? '') ?></td>
                            <td><span class="status-badge status-<?= $row['is_active'] ? 'active' : 'inactive' ?>"><?= $row['is_active'] ? 'Active' : 'Inactive' ?></span></td>
                            <td><a class="small-button" href="<?= e(adminUrl('homepage/slide.php?id=' . (int)$row['id'])) ?>">Edit</a></td>
                        </tr><?php endforeach; ?>
                </tbody>
            </table>
        </div>
    ...
    <section class="content-panel" id="homepage-why">
        ...
        <div class="table-wrap">
            <table class="admin-table">
                ...
                <tbody>
                    <?php foreach ($stats as $row): ?><tr>
                            <td><?= e((string)$row['sort_order']) ?></td>
                            <td><strong><?= e((string)($row['prefix'] ?? '')) ?><?= e((string)$row['number_value']) ?><?= e((string)($row['suffix'] ?? '')) ?></strong></td>
                            <td><?= e($row['label']) ?></td>
                            <td><span class="status-badge status-<?= $row['is_active'] ? 'active' : 'inactive' ?>"><?= $row['is_active'] ? 'Active' : 'Inactive' ?></span></td>
    ...
    <section class="content-panel">
        <div class="panel-heading">
            <div>
                ...
                <p class="muted">The current three inner tabs and their bullet lists.</p>
            </div><a class="button-link" href="<?= e(adminUrl('homepage/why.php')) ?>">+ Add tab</a>
        </div>
        <div class="table-wrap">
            <table class="admin-table">
                <thead>
                ...
                <tbody>
                    <?php foreach ($whyTabs as $row): ?><tr>
                            <td><?= e((string)$row['sort_order']) ?></td>
                            <td><code><?= e((string)$row['legacy_id']) ?></code></td>
                            <td><?= e($row['tab_name']) ?></td>
                            <td><?= e((string)count($row['items'])) ?></td>
                            <td><span class="status-badge status-<?= $row['is_active'] ? 'active' : 'inactive' ?>"><?= $row['is_active'] ? 'Active' : 'Inactive' ?></span></td>
                            <td><a class="small-button" href="<?= e(adminUrl('homepage/why.php?id=' . (int)$row['id'])) ?>">Edit</a></td>
                        </tr><?php endforeach; ?>
                </tbody>
            </table>
        </div>
